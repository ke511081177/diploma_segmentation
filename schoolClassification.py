    ...
    def detect_all_text(self,file):
        ...
        if len(buffer) != 0:
            ...
            if len(buffer) == 0 or len(c) < 4:
                ...
                #cv2.imwrite('{}/{}/{}/{}.png'.format(folderpath,tempSchool,file,file),tempImg)
                self.stampCut()
                cv2.imwrite('{}/{}/{}/{}_stamp.png'.format(folderpath,tempSchool,file,file),self.img)
                #f = open('{}/{}/{}/{}_info.txt'.format(folderpath,tempSchool,file,file), 'w')
